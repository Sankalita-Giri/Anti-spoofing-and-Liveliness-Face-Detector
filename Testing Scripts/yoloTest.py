...
#cap = cv2.VideoCapture("../Videos/motorbike.mp4") #For video
model =YOLO("../models/yolov8n.pt")
classNames =["person","bicycle","car","motorbike","aeroplane","bus","train","truck","boat","traffic light","fire hydrant","stop sign",
             "parking meter","bench","bird","cat","dog","horse","sheep","cow","elephant", "zebra", "giraffe","backpack", "umbrella",
             ...
             "bed", "diningtable", "toilet", "tvmonitor", "laptop", "mouse","remote", "keyboard", "phone", "microwave", "oven", "toaster",
             "sink", "refrigerator", "book", "clock", "vase", "scissors",   "teddy bear", "hair drier", "toothbrush" ,"calender" ]
